...
import cnn.fcn.fcn8_vgg as fcn8_vgg
...
with tf.Session() as sess:
    ...
    fcn8_downsampled = os.path.join(test_result_dir, 'fcn8_downsampled.png')
    fcn8_upsampled = os.path.join(test_result_dir, 'fcn8_upsampled.png')
    scp.misc.imsave(fcn8_downsampled, down_color)
    scp.misc.imsave(fcn8_upsampled, up_color)
