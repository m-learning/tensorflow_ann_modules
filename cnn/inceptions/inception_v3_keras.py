...
Inception-V3 model on Keras from Keras repository
...
from cnn.utils.imagenet_utils import decode_predictions
import numpy as np
...
if __name__ == '__main__':
  ...
  img_path = _files.join_path(TEST_DIR, 'elephant.jpg')
